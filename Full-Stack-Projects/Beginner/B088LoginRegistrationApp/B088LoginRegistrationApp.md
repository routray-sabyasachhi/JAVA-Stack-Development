...
## Synopsis
Login Registration App is a beginner Java full-stack project in the Productivity and Full-Stack Applications domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Login Registration App.
...
- POST /api/auth/login
- GET /api/loginregistrationapp
- POST /api/loginregistrationapp
- GET /api/loginregistrationapp/{id}
- PUT /api/loginregistrationapp/{id}
- DELETE /api/loginregistrationapp/{id}
- GET /api/loginregistrationapp/search
