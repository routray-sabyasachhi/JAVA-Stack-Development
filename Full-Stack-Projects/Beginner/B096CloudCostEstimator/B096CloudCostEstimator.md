...
## Synopsis
Cloud Cost Estimator is a beginner Java full-stack project in the Developer Tools and Platform Engineering domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Cloud Cost Estimator.
...
- POST /api/auth/login
- GET /api/cloudcostestimator
- POST /api/cloudcostestimator
- GET /api/cloudcostestimator/{id}
- PUT /api/cloudcostestimator/{id}
- DELETE /api/cloudcostestimator/{id}
- GET /api/cloudcostestimator/search
