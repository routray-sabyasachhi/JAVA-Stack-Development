...
## Synopsis
Travel Planner is a beginner Java full-stack project in the Travel and Hospitality domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Travel Planner.
...
- POST /api/travelplanner
- GET /api/travelplanner/{id}
- PUT /api/travelplanner/{id}
- DELETE /api/travelplanner/{id}
- GET /api/travelplanner/search
