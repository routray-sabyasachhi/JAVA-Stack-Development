...
## Synopsis
Role Based Dashboard is a beginner Java full-stack project in the Analytics domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Role Based Dashboard.
...
- POST /api/auth/login
- GET /api/rolebaseddashboard
- POST /api/rolebaseddashboard
- GET /api/rolebaseddashboard/{id}
- PUT /api/rolebaseddashboard/{id}
- DELETE /api/rolebaseddashboard/{id}
- GET /api/rolebaseddashboard/search
