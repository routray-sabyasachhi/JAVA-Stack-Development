...
## Synopsis
Chatbot Mockup is a beginner Java full-stack project in the Social and Communication domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Chatbot Mockup.
...
- POST /api/auth/login
- GET /api/chatbotmockup
- POST /api/chatbotmockup
- GET /api/chatbotmockup/{id}
- PUT /api/chatbotmockup/{id}
- DELETE /api/chatbotmockup/{id}
- GET /api/chatbotmockup/search
