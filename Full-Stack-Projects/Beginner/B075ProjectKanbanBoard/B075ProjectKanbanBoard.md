...
## Synopsis
Project Kanban Board is a beginner Java full-stack project in the Productivity and Full-Stack Applications domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Project Kanban Board.
...
- POST /api/auth/login
- GET /api/projectkanbanboard
- POST /api/projectkanbanboard
- GET /api/projectkanbanboard/{id}
- PUT /api/projectkanbanboard/{id}
- DELETE /api/projectkanbanboard/{id}
- GET /api/projectkanbanboard/search
