...
## Synopsis
Authentication Starter is a beginner Java full-stack project in the Developer Tools and Platform Engineering domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Authentication Starter.
...
- POST /api/auth/login
- GET /api/authenticationstarter
- POST /api/authenticationstarter
- GET /api/authenticationstarter/{id}
- PUT /api/authenticationstarter/{id}
- DELETE /api/authenticationstarter/{id}
- GET /api/authenticationstarter/search
