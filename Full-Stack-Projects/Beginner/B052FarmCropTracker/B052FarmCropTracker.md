...
## Synopsis
Farm Crop Tracker is a beginner Java full-stack project in the Agriculture domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Farm Crop Tracker.
...
- POST /api/auth/login
- GET /api/farmcroptracker
- POST /api/farmcroptracker
- GET /api/farmcroptracker/{id}
- PUT /api/farmcroptracker/{id}
- DELETE /api/farmcroptracker/{id}
- GET /api/farmcroptracker/search
