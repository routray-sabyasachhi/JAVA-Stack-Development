...
## Synopsis
Stock Watchlist is a beginner Java full-stack project in the Finance and Banking domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Stock Watchlist.
...
- POST /api/auth/login
- GET /api/stockwatchlist
- POST /api/stockwatchlist
- GET /api/stockwatchlist/{id}
- PUT /api/stockwatchlist/{id}
- DELETE /api/stockwatchlist/{id}
- GET /api/stockwatchlist/search
