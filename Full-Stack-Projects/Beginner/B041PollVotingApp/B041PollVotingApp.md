...
## Synopsis
Poll Voting App is a beginner Java full-stack project in the Productivity and Full-Stack Applications domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Poll Voting App.
...
- POST /api/auth/login
- GET /api/pollvotingapp
- POST /api/pollvotingapp
- GET /api/pollvotingapp/{id}
- PUT /api/pollvotingapp/{id}
- DELETE /api/pollvotingapp/{id}
- GET /api/pollvotingapp/search
