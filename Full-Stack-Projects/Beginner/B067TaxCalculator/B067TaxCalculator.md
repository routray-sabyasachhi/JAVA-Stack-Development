...
## Synopsis
Tax Calculator is a beginner Java full-stack project in the Finance and Banking domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Tax Calculator.
...
- GET /api/taxcalculator/{id}
- PUT /api/taxcalculator/{id}
- DELETE /api/taxcalculator/{id}
- GET /api/taxcalculator/search
