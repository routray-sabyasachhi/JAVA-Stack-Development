...
## Synopsis
Attendance Tracker is a beginner Java full-stack project in the Productivity and Full-Stack Applications domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Attendance Tracker.
...
- POST /api/auth/login
- GET /api/attendancetracker
- POST /api/attendancetracker
- GET /api/attendancetracker/{id}
- PUT /api/attendancetracker/{id}
- DELETE /api/attendancetracker/{id}
- GET /api/attendancetracker/search
