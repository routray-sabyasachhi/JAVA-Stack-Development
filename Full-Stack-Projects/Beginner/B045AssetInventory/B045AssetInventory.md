...
## Synopsis
Asset Inventory is a beginner Java full-stack project in the Logistics and Operations domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Asset Inventory.
...
- GET /api/assetinventory/{id}
- PUT /api/assetinventory/{id}
- DELETE /api/assetinventory/{id}
- GET /api/assetinventory/search
