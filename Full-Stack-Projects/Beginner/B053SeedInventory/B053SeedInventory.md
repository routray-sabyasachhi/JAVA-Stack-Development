...
## Synopsis
Seed Inventory is a beginner Java full-stack project in the Agriculture domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Seed Inventory.
...
- POST /api/auth/login
- GET /api/seedinventory
- POST /api/seedinventory
- GET /api/seedinventory/{id}
- PUT /api/seedinventory/{id}
- DELETE /api/seedinventory/{id}
- GET /api/seedinventory/search
