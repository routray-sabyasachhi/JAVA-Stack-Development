...
## Synopsis
Music Playlist Manager is a beginner Java full-stack project in the Productivity and Full-Stack Applications domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Music Playlist Manager.
...
- POST /api/auth/login
- GET /api/musicplaylistmanager
- POST /api/musicplaylistmanager
- GET /api/musicplaylistmanager/{id}
- PUT /api/musicplaylistmanager/{id}
- DELETE /api/musicplaylistmanager/{id}
- GET /api/musicplaylistmanager/search
