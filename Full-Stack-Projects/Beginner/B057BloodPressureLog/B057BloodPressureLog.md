...
## Synopsis
Blood Pressure Log is a beginner Java full-stack project in the Healthcare domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Blood Pressure Log.
...
- POST /api/auth/login
- GET /api/bloodpressurelog
- POST /api/bloodpressurelog
- GET /api/bloodpressurelog/{id}
- PUT /api/bloodpressurelog/{id}
- DELETE /api/bloodpressurelog/{id}
- GET /api/bloodpressurelog/search
