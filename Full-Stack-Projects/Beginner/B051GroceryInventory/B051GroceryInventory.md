...
## Synopsis
Grocery Inventory is a beginner Java full-stack project in the Logistics and Operations domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Grocery Inventory.
...
- POST /api/auth/login
- GET /api/groceryinventory
- POST /api/groceryinventory
- GET /api/groceryinventory/{id}
- PUT /api/groceryinventory/{id}
- DELETE /api/groceryinventory/{id}
- GET /api/groceryinventory/search
