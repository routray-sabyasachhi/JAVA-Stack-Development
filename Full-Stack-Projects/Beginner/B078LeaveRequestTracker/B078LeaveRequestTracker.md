...
## Synopsis
Leave Request Tracker is a beginner Java full-stack project in the HR and Enterprise domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Leave Request Tracker.
...
- POST /api/auth/login
- GET /api/leaverequesttracker
- POST /api/leaverequesttracker
- GET /api/leaverequesttracker/{id}
- PUT /api/leaverequesttracker/{id}
- DELETE /api/leaverequesttracker/{id}
- GET /api/leaverequesttracker/search
