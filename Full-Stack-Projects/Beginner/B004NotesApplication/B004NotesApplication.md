...
## Synopsis
Notes Application is a beginner Java full-stack project in the Productivity and Full-Stack Applications domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Notes Application.
...
- POST /api/auth/login
- GET /api/notesapplication
- POST /api/notesapplication
- GET /api/notesapplication/{id}
- PUT /api/notesapplication/{id}
- DELETE /api/notesapplication/{id}
- GET /api/notesapplication/search
