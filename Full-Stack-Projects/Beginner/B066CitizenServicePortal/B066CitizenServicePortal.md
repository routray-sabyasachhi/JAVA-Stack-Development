...
## Synopsis
Citizen Service Portal is a beginner Java full-stack project in the Government and Civic Services domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Citizen Service Portal.
...
- POST /api/auth/login
- GET /api/citizenserviceportal
- POST /api/citizenserviceportal
- GET /api/citizenserviceportal/{id}
- PUT /api/citizenserviceportal/{id}
- DELETE /api/citizenserviceportal/{id}
- GET /api/citizenserviceportal/search
