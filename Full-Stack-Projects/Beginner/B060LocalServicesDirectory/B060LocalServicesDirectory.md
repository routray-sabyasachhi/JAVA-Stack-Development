...
## Synopsis
Local Services Directory is a beginner Java full-stack project in the Productivity and Full-Stack Applications domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Local Services Directory.
...
- POST /api/auth/login
- GET /api/localservicesdirectory
- POST /api/localservicesdirectory
- GET /api/localservicesdirectory/{id}
- PUT /api/localservicesdirectory/{id}
- DELETE /api/localservicesdirectory/{id}
- GET /api/localservicesdirectory/search
