...
## Synopsis
Online Exam Practice is a beginner Java full-stack project in the Education domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Online Exam Practice.
...
- POST /api/auth/login
- GET /api/onlineexampractice
- POST /api/onlineexampractice
- GET /api/onlineexampractice/{id}
- PUT /api/onlineexampractice/{id}
- DELETE /api/onlineexampractice/{id}
- GET /api/onlineexampractice/search
