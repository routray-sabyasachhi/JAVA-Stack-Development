...
## Synopsis
Bookmark Manager is a beginner Java full-stack project in the Productivity and Full-Stack Applications domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Bookmark Manager.
...
- POST /api/auth/login
- GET /api/bookmarkmanager
- POST /api/bookmarkmanager
- GET /api/bookmarkmanager/{id}
- PUT /api/bookmarkmanager/{id}
- DELETE /api/bookmarkmanager/{id}
- GET /api/bookmarkmanager/search
