...
## Synopsis
Savings Goal Tracker is a beginner Java full-stack project in the Finance and Banking domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Savings Goal Tracker.
...
- POST /api/auth/login
- GET /api/savingsgoaltracker
- POST /api/savingsgoaltracker
- GET /api/savingsgoaltracker/{id}
- PUT /api/savingsgoaltracker/{id}
- DELETE /api/savingsgoaltracker/{id}
- GET /api/savingsgoaltracker/search
