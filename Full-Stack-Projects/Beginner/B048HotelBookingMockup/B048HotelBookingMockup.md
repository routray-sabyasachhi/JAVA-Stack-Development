...
## Synopsis
Hotel Booking Mockup is a beginner Java full-stack project in the Travel and Hospitality domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Hotel Booking Mockup.
...
- POST /api/auth/login
- GET /api/hotelbookingmockup
- POST /api/hotelbookingmockup
- GET /api/hotelbookingmockup/{id}
- PUT /api/hotelbookingmockup/{id}
- DELETE /api/hotelbookingmockup/{id}
- GET /api/hotelbookingmockup/search
