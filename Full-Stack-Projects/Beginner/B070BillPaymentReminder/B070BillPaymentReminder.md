...
## Synopsis
Bill Payment Reminder is a beginner Java full-stack project in the Finance and Banking domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Bill Payment Reminder.
...
- POST /api/auth/login
- GET /api/billpaymentreminder
- POST /api/billpaymentreminder
- GET /api/billpaymentreminder/{id}
- PUT /api/billpaymentreminder/{id}
- DELETE /api/billpaymentreminder/{id}
- GET /api/billpaymentreminder/search
