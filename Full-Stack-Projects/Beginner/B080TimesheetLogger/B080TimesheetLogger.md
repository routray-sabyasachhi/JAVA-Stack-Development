...
## Synopsis
Timesheet Logger is a beginner Java full-stack project in the HR and Enterprise domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Timesheet Logger.
...
- POST /api/auth/login
- GET /api/timesheetlogger
- POST /api/timesheetlogger
- GET /api/timesheetlogger/{id}
- PUT /api/timesheetlogger/{id}
- DELETE /api/timesheetlogger/{id}
- GET /api/timesheetlogger/search
