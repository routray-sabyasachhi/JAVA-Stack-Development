...
## Synopsis
Daily Journal is a beginner Java full-stack project in the AI Applications domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Daily Journal.
...
- POST /api/auth/login
- GET /api/dailyjournal
- POST /api/dailyjournal
- GET /api/dailyjournal/{id}
- PUT /api/dailyjournal/{id}
- DELETE /api/dailyjournal/{id}
- GET /api/dailyjournal/search
