...
## Synopsis
Quiz Application is a beginner Java full-stack project in the Education domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Quiz Application.
...
- POST /api/auth/login
- GET /api/quizapplication
- POST /api/quizapplication
- GET /api/quizapplication/{id}
- PUT /api/quizapplication/{id}
- DELETE /api/quizapplication/{id}
- GET /api/quizapplication/search
