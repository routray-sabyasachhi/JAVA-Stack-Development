...
## Synopsis
Unit Converter is a beginner Java full-stack project in the Productivity and Full-Stack Applications domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Unit Converter.
...
- POST /api/unitconverter
- GET /api/unitconverter/{id}
- PUT /api/unitconverter/{id}
- DELETE /api/unitconverter/{id}
- GET /api/unitconverter/search
