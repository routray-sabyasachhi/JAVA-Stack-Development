...
## Synopsis
Docker Command Notes is a beginner Java full-stack project in the Developer Tools and Platform Engineering domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Docker Command Notes.
...
- POST /api/auth/login
- GET /api/dockercommandnotes
- POST /api/dockercommandnotes
- GET /api/dockercommandnotes/{id}
- PUT /api/dockercommandnotes/{id}
- DELETE /api/dockercommandnotes/{id}
- GET /api/dockercommandnotes/search
