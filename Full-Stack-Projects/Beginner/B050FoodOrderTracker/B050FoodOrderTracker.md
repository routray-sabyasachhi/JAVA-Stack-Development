...
## Synopsis
Food Order Tracker is a beginner Java full-stack project in the E-commerce domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Food Order Tracker.
...
- POST /api/auth/login
- GET /api/foodordertracker
- POST /api/foodordertracker
- GET /api/foodordertracker/{id}
- PUT /api/foodordertracker/{id}
- DELETE /api/foodordertracker/{id}
- GET /api/foodordertracker/search
