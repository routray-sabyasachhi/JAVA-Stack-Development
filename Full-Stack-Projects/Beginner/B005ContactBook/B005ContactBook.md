...
## Synopsis
Contact Book is a beginner Java full-stack project in the Productivity and Full-Stack Applications domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Contact Book.
...
- GET /api/contactbook/{id}
- PUT /api/contactbook/{id}
- DELETE /api/contactbook/{id}
- GET /api/contactbook/search
