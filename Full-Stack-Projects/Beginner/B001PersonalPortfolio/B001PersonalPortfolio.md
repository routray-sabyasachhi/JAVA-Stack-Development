...
## Synopsis
Personal Portfolio is a beginner Java full-stack project in the Productivity and Full-Stack Applications domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Personal Portfolio.
...
- POST /api/auth/login
- GET /api/personalportfolio
- POST /api/personalportfolio
- GET /api/personalportfolio/{id}
- PUT /api/personalportfolio/{id}
- DELETE /api/personalportfolio/{id}
- GET /api/personalportfolio/search
