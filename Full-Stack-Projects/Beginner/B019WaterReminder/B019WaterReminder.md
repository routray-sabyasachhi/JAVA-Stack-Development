...
## Synopsis
Water Reminder is a beginner Java full-stack project in the Productivity and Full-Stack Applications domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Water Reminder.
...
- POST /api/auth/login
- GET /api/waterreminder
- POST /api/waterreminder
- GET /api/waterreminder/{id}
- PUT /api/waterreminder/{id}
- DELETE /api/waterreminder/{id}
- GET /api/waterreminder/search
