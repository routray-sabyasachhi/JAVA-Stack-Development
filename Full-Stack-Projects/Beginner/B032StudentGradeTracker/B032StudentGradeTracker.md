...
## Synopsis
Student Grade Tracker is a beginner Java full-stack project in the Education domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Student Grade Tracker.
...
- POST /api/auth/login
- GET /api/studentgradetracker
- POST /api/studentgradetracker
- GET /api/studentgradetracker/{id}
- PUT /api/studentgradetracker/{id}
- DELETE /api/studentgradetracker/{id}
- GET /api/studentgradetracker/search
