...
## Synopsis
Loan EMI Calculator is a beginner Java full-stack project in the Finance and Banking domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Loan EMI Calculator.
...
- POST /api/auth/login
- GET /api/loanemicalculator
- POST /api/loanemicalculator
- GET /api/loanemicalculator/{id}
- PUT /api/loanemicalculator/{id}
- DELETE /api/loanemicalculator/{id}
- GET /api/loanemicalculator/search
