...
## Synopsis
API Status Monitor is a beginner Java full-stack project in the Developer Tools and Platform Engineering domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of API Status Monitor.
...
- POST /api/auth/login
- GET /api/apistatusmonitor
- POST /api/apistatusmonitor
- GET /api/apistatusmonitor/{id}
- PUT /api/apistatusmonitor/{id}
- DELETE /api/apistatusmonitor/{id}
- GET /api/apistatusmonitor/search
