...
## Synopsis
Employee Directory is a beginner Java full-stack project in the HR and Enterprise domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Employee Directory.
...
- GET /api/employeedirectory/{id}
- PUT /api/employeedirectory/{id}
- DELETE /api/employeedirectory/{id}
- GET /api/employeedirectory/search
