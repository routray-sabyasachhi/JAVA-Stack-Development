...
## Synopsis
Bank Account Ledger is a beginner Java full-stack project in the Finance and Banking domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Bank Account Ledger.
...
- POST /api/auth/login
- GET /api/bankaccountledger
- POST /api/bankaccountledger
- GET /api/bankaccountledger/{id}
- PUT /api/bankaccountledger/{id}
- DELETE /api/bankaccountledger/{id}
- GET /api/bankaccountledger/search
