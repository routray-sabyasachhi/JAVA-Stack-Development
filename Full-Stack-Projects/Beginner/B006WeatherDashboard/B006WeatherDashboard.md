...
## Synopsis
Weather Dashboard is a beginner Java full-stack project in the Analytics domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Weather Dashboard.
...
- POST /api/weatherdashboard
- GET /api/weatherdashboard/{id}
- PUT /api/weatherdashboard/{id}
- DELETE /api/weatherdashboard/{id}
- GET /api/weatherdashboard/search
