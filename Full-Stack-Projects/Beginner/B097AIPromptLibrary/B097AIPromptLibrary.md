...
## Synopsis
AI Prompt Library is a beginner Java full-stack project in the AI Applications domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of AI Prompt Library.
...
- POST /api/auth/login
- GET /api/aipromptlibrary
- POST /api/aipromptlibrary
- GET /api/aipromptlibrary/{id}
- PUT /api/aipromptlibrary/{id}
- DELETE /api/aipromptlibrary/{id}
- GET /api/aipromptlibrary/search
