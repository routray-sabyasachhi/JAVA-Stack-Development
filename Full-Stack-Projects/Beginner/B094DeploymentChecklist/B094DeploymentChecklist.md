...
## Synopsis
Deployment Checklist is a beginner Java full-stack project in the Developer Tools and Platform Engineering domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Deployment Checklist.
...
- POST /api/auth/login
- GET /api/deploymentchecklist
- POST /api/deploymentchecklist
- GET /api/deploymentchecklist/{id}
- PUT /api/deploymentchecklist/{id}
- DELETE /api/deploymentchecklist/{id}
- GET /api/deploymentchecklist/search
