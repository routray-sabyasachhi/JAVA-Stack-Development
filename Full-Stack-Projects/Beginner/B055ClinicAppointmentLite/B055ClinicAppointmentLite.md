# Clinic Appointment Lite

## Synopsis
Clinic Appointment Lite is a beginner Java full-stack project in the Healthcare domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Clinic Appointment Lite.
...
- POST /api/auth/login
- GET /api/clinicappointmentlite
- POST /api/clinicappointmentlite
- GET /api/clinicappointmentlite/{id}
- PUT /api/clinicappointmentlite/{id}
- DELETE /api/clinicappointmentlite/{id}
- GET /api/clinicappointmentlite/search
