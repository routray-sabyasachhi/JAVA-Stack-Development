...
## Synopsis
Vendor Directory is a beginner Java full-stack project in the E-commerce domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Vendor Directory.
...
- POST /api/auth/login
- GET /api/vendordirectory
- POST /api/vendordirectory
- GET /api/vendordirectory/{id}
- PUT /api/vendordirectory/{id}
- DELETE /api/vendordirectory/{id}
- GET /api/vendordirectory/search
