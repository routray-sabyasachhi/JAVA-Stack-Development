...
## Synopsis
Crypto Price Tracker is a beginner Java full-stack project in the Finance and Banking domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Crypto Price Tracker.
...
- POST /api/auth/login
- GET /api/cryptopricetracker
- POST /api/cryptopricetracker
- GET /api/cryptopricetracker/{id}
- PUT /api/cryptopricetracker/{id}
- DELETE /api/cryptopricetracker/{id}
- GET /api/cryptopricetracker/search
