...
## Synopsis
Flashcard Trainer is a beginner Java full-stack project in the Education domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Flashcard Trainer.
...
- POST /api/auth/login
- GET /api/flashcardtrainer
- POST /api/flashcardtrainer
- GET /api/flashcardtrainer/{id}
- PUT /api/flashcardtrainer/{id}
- DELETE /api/flashcardtrainer/{id}
- GET /api/flashcardtrainer/search
