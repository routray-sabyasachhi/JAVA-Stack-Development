...
## Synopsis
Landing Page Builder is a beginner Java full-stack project in the Government and Civic Services domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Landing Page Builder.
...
- POST /api/auth/login
- GET /api/landingpagebuilder
- POST /api/landingpagebuilder
- GET /api/landingpagebuilder/{id}
- PUT /api/landingpagebuilder/{id}
- DELETE /api/landingpagebuilder/{id}
- GET /api/landingpagebuilder/search
