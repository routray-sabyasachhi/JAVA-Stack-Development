...
## Synopsis
Complaint Register is a beginner Java full-stack project in the AI Applications domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Complaint Register.
...
- POST /api/auth/login
- GET /api/complaintregister
- POST /api/complaintregister
- GET /api/complaintregister/{id}
- PUT /api/complaintregister/{id}
- DELETE /api/complaintregister/{id}
- GET /api/complaintregister/search
