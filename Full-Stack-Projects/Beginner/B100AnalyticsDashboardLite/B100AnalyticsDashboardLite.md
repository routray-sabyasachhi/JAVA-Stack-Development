...
## Synopsis
Analytics Dashboard Lite is a beginner Java full-stack project in the Analytics domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Analytics Dashboard Lite.
...
- POST /api/auth/login
- GET /api/analyticsdashboardlite
- POST /api/analyticsdashboardlite
- GET /api/analyticsdashboardlite/{id}
- PUT /api/analyticsdashboardlite/{id}
- DELETE /api/analyticsdashboardlite/{id}
- GET /api/analyticsdashboardlite/search
