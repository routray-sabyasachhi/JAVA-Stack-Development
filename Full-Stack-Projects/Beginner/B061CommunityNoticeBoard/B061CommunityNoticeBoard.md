...
## Synopsis
Community Notice Board is a beginner Java full-stack project in the Social and Communication domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Community Notice Board.
...
- POST /api/auth/login
- GET /api/communitynoticeboard
- POST /api/communitynoticeboard
- GET /api/communitynoticeboard/{id}
- PUT /api/communitynoticeboard/{id}
- DELETE /api/communitynoticeboard/{id}
- GET /api/communitynoticeboard/search
