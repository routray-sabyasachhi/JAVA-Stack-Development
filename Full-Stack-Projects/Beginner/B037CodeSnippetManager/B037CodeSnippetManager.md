...
## Synopsis
Code Snippet Manager is a beginner Java full-stack project in the Productivity and Full-Stack Applications domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Code Snippet Manager.
...
- POST /api/auth/login
- GET /api/codesnippetmanager
- POST /api/codesnippetmanager
- GET /api/codesnippetmanager/{id}
- PUT /api/codesnippetmanager/{id}
- DELETE /api/codesnippetmanager/{id}
- GET /api/codesnippetmanager/search
