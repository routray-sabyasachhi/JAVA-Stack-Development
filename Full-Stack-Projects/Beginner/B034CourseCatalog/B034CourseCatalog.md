...
## Synopsis
Course Catalog is a beginner Java full-stack project in the Education domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Course Catalog.
...
- GET /api/coursecatalog/{id}
- PUT /api/coursecatalog/{id}
- DELETE /api/coursecatalog/{id}
- GET /api/coursecatalog/search
