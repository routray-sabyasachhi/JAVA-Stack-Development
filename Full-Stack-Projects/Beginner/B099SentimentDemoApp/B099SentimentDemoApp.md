...
## Synopsis
Sentiment Demo App is a beginner Java full-stack project in the AI Applications domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Sentiment Demo App.
...
- POST /api/auth/login
- GET /api/sentimentdemoapp
- POST /api/sentimentdemoapp
- GET /api/sentimentdemoapp/{id}
- PUT /api/sentimentdemoapp/{id}
- DELETE /api/sentimentdemoapp/{id}
- GET /api/sentimentdemoapp/search
