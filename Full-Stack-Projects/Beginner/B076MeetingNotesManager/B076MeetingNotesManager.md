...
## Synopsis
Meeting Notes Manager is a beginner Java full-stack project in the Productivity and Full-Stack Applications domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Meeting Notes Manager.
...
- POST /api/auth/login
- GET /api/meetingnotesmanager
- POST /api/meetingnotesmanager
- GET /api/meetingnotesmanager/{id}
- PUT /api/meetingnotesmanager/{id}
- DELETE /api/meetingnotesmanager/{id}
- GET /api/meetingnotesmanager/search
