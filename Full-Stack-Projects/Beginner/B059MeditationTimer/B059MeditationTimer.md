...
## Synopsis
Meditation Timer is a beginner Java full-stack project in the Productivity and Full-Stack Applications domain. A focused CRUD-style Java full-stack project for practicing clean UI screens, REST endpoints, validation, SQL persistence, and simple authentication where useful.
...
Adjust these entities based on the exact domain of Meditation Timer.
...
- POST /api/auth/login
- GET /api/meditationtimer
- POST /api/meditationtimer
- GET /api/meditationtimer/{id}
- PUT /api/meditationtimer/{id}
- DELETE /api/meditationtimer/{id}
- GET /api/meditationtimer/search
