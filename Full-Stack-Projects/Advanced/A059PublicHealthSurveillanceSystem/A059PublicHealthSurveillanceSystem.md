...
## Synopsis
Public Health Surveillance System is an advanced Java full-stack project in the Healthcare domain. A large portfolio-grade Java full-stack platform that practices system design, modular architecture, security, observability, async workflows, AI integration where useful, and scalable deployment.
...
This project reflects a realistic business problem from the Healthcare domain. It is portfolio-worthy because it demonstrates how to convert a real-world workflow into a working Java full-stack application with clean architecture, database design, and deployment awareness.
...
Adjust these entities based on the exact domain of Public Health Surveillance System.
...
- POST /api/auth/login
- GET /api/publichealthsurveillancesystem
- POST /api/publichealthsurveillancesystem
- GET /api/publichealthsurveillancesystem/{id}
- PUT /api/publichealthsurveillancesystem/{id}
- DELETE /api/publichealthsurveillancesystem/{id}
- GET /api/publichealthsurveillancesystem/search
