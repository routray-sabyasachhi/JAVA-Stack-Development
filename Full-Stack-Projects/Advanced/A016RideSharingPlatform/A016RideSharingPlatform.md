...
Adjust these entities based on the exact domain of Ride Sharing Platform.
...
- POST /api/auth/login
- GET /api/ridesharingplatform
- POST /api/ridesharingplatform
- GET /api/ridesharingplatform/{id}
- PUT /api/ridesharingplatform/{id}
- DELETE /api/ridesharingplatform/{id}
- GET /api/ridesharingplatform/search
