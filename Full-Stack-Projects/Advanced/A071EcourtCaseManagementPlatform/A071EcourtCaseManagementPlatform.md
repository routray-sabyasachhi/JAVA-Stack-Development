...
Adjust these entities based on the exact domain of Ecourt Case Management Platform.
...
- POST /api/auth/login
- GET /api/ecourtcasemanagementplatform
- POST /api/ecourtcasemanagementplatform
- GET /api/ecourtcasemanagementplatform/{id}
- PUT /api/ecourtcasemanagementplatform/{id}
- DELETE /api/ecourtcasemanagementplatform/{id}
- GET /api/ecourtcasemanagementplatform/search
