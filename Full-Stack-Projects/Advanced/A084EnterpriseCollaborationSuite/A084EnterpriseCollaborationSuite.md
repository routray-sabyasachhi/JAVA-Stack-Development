...
Adjust these entities based on the exact domain of Enterprise Collaboration Suite.
...
- POST /api/auth/login
- GET /api/enterprisecollaborationsuite
- POST /api/enterprisecollaborationsuite
- GET /api/enterprisecollaborationsuite/{id}
- PUT /api/enterprisecollaborationsuite/{id}
- DELETE /api/enterprisecollaborationsuite/{id}
- GET /api/enterprisecollaborationsuite/search
