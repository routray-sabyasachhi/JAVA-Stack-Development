...
Adjust these entities based on the exact domain of Marketing Automation Suite.
...
- POST /api/auth/login
- GET /api/marketingautomationsuite
- POST /api/marketingautomationsuite
- GET /api/marketingautomationsuite/{id}
- PUT /api/marketingautomationsuite/{id}
- DELETE /api/marketingautomationsuite/{id}
- GET /api/marketingautomationsuite/search
