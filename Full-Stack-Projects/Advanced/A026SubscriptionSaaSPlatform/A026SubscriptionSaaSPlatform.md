...
Adjust these entities based on the exact domain of Subscription Saa S Platform.
...
- POST /api/auth/login
- GET /api/subscriptionsaasplatform
- POST /api/subscriptionsaasplatform
- GET /api/subscriptionsaasplatform/{id}
- PUT /api/subscriptionsaasplatform/{id}
- DELETE /api/subscriptionsaasplatform/{id}
- GET /api/subscriptionsaasplatform/search
