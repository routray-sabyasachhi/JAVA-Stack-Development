...
Adjust these entities based on the exact domain of Land Registry Blockchain System.
...
- POST /api/auth/login
- GET /api/landregistryblockchainsystem
- POST /api/landregistryblockchainsystem
- GET /api/landregistryblockchainsystem/{id}
- PUT /api/landregistryblockchainsystem/{id}
- DELETE /api/landregistryblockchainsystem/{id}
- GET /api/landregistryblockchainsystem/search
