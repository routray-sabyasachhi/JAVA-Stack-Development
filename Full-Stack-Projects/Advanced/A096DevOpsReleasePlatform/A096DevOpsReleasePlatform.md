...
Adjust these entities based on the exact domain of Dev Ops Release Platform.
...
- POST /api/auth/login
- GET /api/devopsreleaseplatform
- POST /api/devopsreleaseplatform
- GET /api/devopsreleaseplatform/{id}
- PUT /api/devopsreleaseplatform/{id}
- DELETE /api/devopsreleaseplatform/{id}
- GET /api/devopsreleaseplatform/search
