...
Adjust these entities based on the exact domain of API Management Gateway.
...
- POST /api/auth/login
- GET /api/apimanagementgateway
- POST /api/apimanagementgateway
- GET /api/apimanagementgateway/{id}
- PUT /api/apimanagementgateway/{id}
- DELETE /api/apimanagementgateway/{id}
- GET /api/apimanagementgateway/search
