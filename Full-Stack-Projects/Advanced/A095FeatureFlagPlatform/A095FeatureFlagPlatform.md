...
Adjust these entities based on the exact domain of Feature Flag Platform.
...
- POST /api/auth/login
- GET /api/featureflagplatform
- POST /api/featureflagplatform
- GET /api/featureflagplatform/{id}
- PUT /api/featureflagplatform/{id}
- DELETE /api/featureflagplatform/{id}
- GET /api/featureflagplatform/search
