...
Adjust these entities based on the exact domain of Observability Monitoring Platform.
...
- POST /api/auth/login
- GET /api/observabilitymonitoringplatform
- POST /api/observabilitymonitoringplatform
- GET /api/observabilitymonitoringplatform/{id}
- PUT /api/observabilitymonitoringplatform/{id}
- DELETE /api/observabilitymonitoringplatform/{id}
- GET /api/observabilitymonitoringplatform/search
