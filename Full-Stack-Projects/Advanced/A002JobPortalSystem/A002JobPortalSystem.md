...
Adjust these entities based on the exact domain of Job Portal System.
...
- POST /api/auth/login
- GET /api/jobportalsystem
- POST /api/jobportalsystem
- GET /api/jobportalsystem/{id}
- PUT /api/jobportalsystem/{id}
- DELETE /api/jobportalsystem/{id}
- GET /api/jobportalsystem/search
