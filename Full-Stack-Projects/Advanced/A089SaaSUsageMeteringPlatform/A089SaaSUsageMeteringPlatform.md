...
Adjust these entities based on the exact domain of Saa S Usage Metering Platform.
...
- POST /api/auth/login
- GET /api/saasusagemeteringplatform
- POST /api/saasusagemeteringplatform
- GET /api/saasusagemeteringplatform/{id}
- PUT /api/saasusagemeteringplatform/{id}
- DELETE /api/saasusagemeteringplatform/{id}
- GET /api/saasusagemeteringplatform/search
