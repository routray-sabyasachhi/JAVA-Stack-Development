...
Adjust these entities based on the exact domain of Customer Data Platform.
...
- POST /api/auth/login
- GET /api/customerdataplatform
- POST /api/customerdataplatform
- GET /api/customerdataplatform/{id}
- PUT /api/customerdataplatform/{id}
- DELETE /api/customerdataplatform/{id}
- GET /api/customerdataplatform/search
