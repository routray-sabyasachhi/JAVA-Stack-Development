...
## Synopsis
Travel Super App is an advanced Java full-stack project in the Travel and Hospitality domain. A large portfolio-grade Java full-stack platform that practices system design, modular architecture, security, observability, async workflows, AI integration where useful, and scalable deployment.
...
Adjust these entities based on the exact domain of Travel Super App.
...
- POST /api/auth/login
- GET /api/travelsuperapp
- POST /api/travelsuperapp
- GET /api/travelsuperapp/{id}
- PUT /api/travelsuperapp/{id}
- DELETE /api/travelsuperapp/{id}
- GET /api/travelsuperapp/search
