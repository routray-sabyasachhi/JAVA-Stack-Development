...
Adjust these entities based on the exact domain of Digital Identity Verification System.
...
- POST /api/auth/login
- GET /api/digitalidentityverificationsystem
- POST /api/digitalidentityverificationsystem
- GET /api/digitalidentityverificationsystem/{id}
- PUT /api/digitalidentityverificationsystem/{id}
- DELETE /api/digitalidentityverificationsystem/{id}
- GET /api/digitalidentityverificationsystem/search
