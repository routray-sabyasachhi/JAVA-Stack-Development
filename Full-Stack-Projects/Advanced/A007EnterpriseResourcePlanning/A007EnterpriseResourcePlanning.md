...
Adjust these entities based on the exact domain of Enterprise Resource Planning.
...
- POST /api/auth/login
- GET /api/enterpriseresourceplanning
- POST /api/enterpriseresourceplanning
- GET /api/enterpriseresourceplanning/{id}
- PUT /api/enterpriseresourceplanning/{id}
- DELETE /api/enterpriseresourceplanning/{id}
- GET /api/enterpriseresourceplanning/search
