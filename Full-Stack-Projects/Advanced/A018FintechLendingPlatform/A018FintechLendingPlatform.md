...
Adjust these entities based on the exact domain of Fintech Lending Platform.
...
- POST /api/auth/login
- GET /api/fintechlendingplatform
- POST /api/fintechlendingplatform
- GET /api/fintechlendingplatform/{id}
- PUT /api/fintechlendingplatform/{id}
- DELETE /api/fintechlendingplatform/{id}
- GET /api/fintechlendingplatform/search
