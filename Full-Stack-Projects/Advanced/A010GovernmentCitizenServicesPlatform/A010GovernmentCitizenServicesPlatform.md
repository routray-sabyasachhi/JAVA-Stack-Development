...
Adjust these entities based on the exact domain of Government Citizen Services Platform.
...
- POST /api/auth/login
- GET /api/governmentcitizenservicesplatform
- POST /api/governmentcitizenservicesplatform
- GET /api/governmentcitizenservicesplatform/{id}
- PUT /api/governmentcitizenservicesplatform/{id}
- DELETE /api/governmentcitizenservicesplatform/{id}
- GET /api/governmentcitizenservicesplatform/search
