...
Adjust these entities based on the exact domain of Zero Trust Admin Console.
...
- POST /api/auth/login
- GET /api/zerotrustadminconsole
- POST /api/zerotrustadminconsole
- GET /api/zerotrustadminconsole/{id}
- PUT /api/zerotrustadminconsole/{id}
- DELETE /api/zerotrustadminconsole/{id}
- GET /api/zerotrustadminconsole/search
