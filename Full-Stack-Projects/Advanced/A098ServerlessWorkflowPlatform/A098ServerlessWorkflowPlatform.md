...
Adjust these entities based on the exact domain of Serverless Workflow Platform.
...
- POST /api/auth/login
- GET /api/serverlessworkflowplatform
- POST /api/serverlessworkflowplatform
- GET /api/serverlessworkflowplatform/{id}
- PUT /api/serverlessworkflowplatform/{id}
- DELETE /api/serverlessworkflowplatform/{id}
- GET /api/serverlessworkflowplatform/search
