...
Adjust these entities based on the exact domain of Procurement Management Platform.
...
- POST /api/auth/login
- GET /api/procurementmanagementplatform
- POST /api/procurementmanagementplatform
- GET /api/procurementmanagementplatform/{id}
- PUT /api/procurementmanagementplatform/{id}
- DELETE /api/procurementmanagementplatform/{id}
- GET /api/procurementmanagementplatform/search
