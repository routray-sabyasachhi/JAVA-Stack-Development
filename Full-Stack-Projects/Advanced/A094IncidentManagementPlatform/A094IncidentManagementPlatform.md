...
Adjust these entities based on the exact domain of Incident Management Platform.
...
- POST /api/auth/login
- GET /api/incidentmanagementplatform
- POST /api/incidentmanagementplatform
- GET /api/incidentmanagementplatform/{id}
- PUT /api/incidentmanagementplatform/{id}
- DELETE /api/incidentmanagementplatform/{id}
- GET /api/incidentmanagementplatform/search
