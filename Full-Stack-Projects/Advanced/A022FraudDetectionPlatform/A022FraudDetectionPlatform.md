...
Adjust these entities based on the exact domain of Fraud Detection Platform.
...
- POST /api/auth/login
- GET /api/frauddetectionplatform
- POST /api/frauddetectionplatform
- GET /api/frauddetectionplatform/{id}
- PUT /api/frauddetectionplatform/{id}
- DELETE /api/frauddetectionplatform/{id}
- GET /api/frauddetectionplatform/search
