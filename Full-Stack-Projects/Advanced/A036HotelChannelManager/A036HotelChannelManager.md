...
## Synopsis
Hotel Channel Manager is an advanced Java full-stack project in the Travel and Hospitality domain. A large portfolio-grade Java full-stack platform that practices system design, modular architecture, security, observability, async workflows, AI integration where useful, and scalable deployment.
...
Adjust these entities based on the exact domain of Hotel Channel Manager.
...
- POST /api/auth/login
- GET /api/hotelchannelmanager
- POST /api/hotelchannelmanager
- GET /api/hotelchannelmanager/{id}
- PUT /api/hotelchannelmanager/{id}
- DELETE /api/hotelchannelmanager/{id}
- GET /api/hotelchannelmanager/search
