...
Adjust these entities based on the exact domain of Customer Relationship Platform.
...
- POST /api/auth/login
- GET /api/customerrelationshipplatform
- POST /api/customerrelationshipplatform
- GET /api/customerrelationshipplatform/{id}
- PUT /api/customerrelationshipplatform/{id}
- DELETE /api/customerrelationshipplatform/{id}
- GET /api/customerrelationshipplatform/search
