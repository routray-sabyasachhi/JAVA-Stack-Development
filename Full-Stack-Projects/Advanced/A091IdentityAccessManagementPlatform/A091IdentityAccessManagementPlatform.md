...
Adjust these entities based on the exact domain of Identity Access Management Platform.
...
- POST /api/auth/login
- GET /api/identityaccessmanagementplatform
- POST /api/identityaccessmanagementplatform
- GET /api/identityaccessmanagementplatform/{id}
- PUT /api/identityaccessmanagementplatform/{id}
- DELETE /api/identityaccessmanagementplatform/{id}
- GET /api/identityaccessmanagementplatform/search
