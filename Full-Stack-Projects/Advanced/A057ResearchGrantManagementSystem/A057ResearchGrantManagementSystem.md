...
Adjust these entities based on the exact domain of Research Grant Management System.
...
- POST /api/auth/login
- GET /api/researchgrantmanagementsystem
- POST /api/researchgrantmanagementsystem
- GET /api/researchgrantmanagementsystem/{id}
- PUT /api/researchgrantmanagementsystem/{id}
- DELETE /api/researchgrantmanagementsystem/{id}
- GET /api/researchgrantmanagementsystem/search
