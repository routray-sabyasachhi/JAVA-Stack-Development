...
## Synopsis
Insurance Policy Manager is an intermediate Java full-stack project in the Finance and Banking domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Insurance Policy Manager.
...
- POST /api/auth/login
- GET /api/insurancepolicymanager
- POST /api/insurancepolicymanager
- GET /api/insurancepolicymanager/{id}
- PUT /api/insurancepolicymanager/{id}
- DELETE /api/insurancepolicymanager/{id}
- GET /api/insurancepolicymanager/search
