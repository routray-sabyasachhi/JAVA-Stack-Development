...
## Synopsis
Customer Loyalty System is an intermediate Java full-stack project in the Productivity and Full-Stack Applications domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Customer Loyalty System.
...
- POST /api/auth/login
- GET /api/customerloyaltysystem
- POST /api/customerloyaltysystem
- GET /api/customerloyaltysystem/{id}
- PUT /api/customerloyaltysystem/{id}
- DELETE /api/customerloyaltysystem/{id}
- GET /api/customerloyaltysystem/search
