...
## Synopsis
Student Portal is an intermediate Java full-stack project in the Education domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Student Portal.
...
- POST /api/auth/login
- GET /api/studentportal
- POST /api/studentportal
- GET /api/studentportal/{id}
- PUT /api/studentportal/{id}
- DELETE /api/studentportal/{id}
- GET /api/studentportal/search
