...
## Synopsis
Fleet Management System is an intermediate Java full-stack project in the Logistics and Operations domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Fleet Management System.
...
- POST /api/auth/login
- GET /api/fleetmanagementsystem
- POST /api/fleetmanagementsystem
- GET /api/fleetmanagementsystem/{id}
- PUT /api/fleetmanagementsystem/{id}
- DELETE /api/fleetmanagementsystem/{id}
- GET /api/fleetmanagementsystem/search
