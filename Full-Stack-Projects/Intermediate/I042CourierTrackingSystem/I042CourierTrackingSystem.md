...
## Synopsis
Courier Tracking System is an intermediate Java full-stack project in the Logistics and Operations domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Courier Tracking System.
...
- POST /api/auth/login
- GET /api/couriertrackingsystem
- POST /api/couriertrackingsystem
- GET /api/couriertrackingsystem/{id}
- PUT /api/couriertrackingsystem/{id}
- DELETE /api/couriertrackingsystem/{id}
- GET /api/couriertrackingsystem/search
