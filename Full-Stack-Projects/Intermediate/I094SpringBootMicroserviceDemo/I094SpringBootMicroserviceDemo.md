...
## Synopsis
Spring Boot Microservice Demo is an intermediate Java full-stack project in the Developer Tools and Platform Engineering domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Spring Boot Microservice Demo.
...
- POST /api/auth/login
- GET /api/springbootmicroservicedemo
- POST /api/springbootmicroservicedemo
- GET /api/springbootmicroservicedemo/{id}
- PUT /api/springbootmicroservicedemo/{id}
- DELETE /api/springbootmicroservicedemo/{id}
- GET /api/springbootmicroservicedemo/search
