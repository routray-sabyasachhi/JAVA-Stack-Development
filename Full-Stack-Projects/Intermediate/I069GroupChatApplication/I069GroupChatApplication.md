...
## Synopsis
Group Chat Application is an intermediate Java full-stack project in the Social and Communication domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Group Chat Application.
...
- POST /api/auth/login
- GET /api/groupchatapplication
- POST /api/groupchatapplication
- GET /api/groupchatapplication/{id}
- PUT /api/groupchatapplication/{id}
- DELETE /api/groupchatapplication/{id}
- GET /api/groupchatapplication/search
