...
## Synopsis
Tutor Booking System is an intermediate Java full-stack project in the Education domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Tutor Booking System.
...
- POST /api/auth/login
- GET /api/tutorbookingsystem
- POST /api/tutorbookingsystem
- GET /api/tutorbookingsystem/{id}
- PUT /api/tutorbookingsystem/{id}
- DELETE /api/tutorbookingsystem/{id}
- GET /api/tutorbookingsystem/search
