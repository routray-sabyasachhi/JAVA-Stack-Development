...
## Synopsis
Tour Package Manager is an intermediate Java full-stack project in the Travel and Hospitality domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Tour Package Manager.
...
- POST /api/auth/login
- GET /api/tourpackagemanager
- POST /api/tourpackagemanager
- GET /api/tourpackagemanager/{id}
- PUT /api/tourpackagemanager/{id}
- DELETE /api/tourpackagemanager/{id}
- GET /api/tourpackagemanager/search
