...
## Synopsis
Shift Scheduling System is an intermediate Java full-stack project in the HR and Enterprise domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Shift Scheduling System.
...
- POST /api/auth/login
- GET /api/shiftschedulingsystem
- POST /api/shiftschedulingsystem
- GET /api/shiftschedulingsystem/{id}
- PUT /api/shiftschedulingsystem/{id}
- DELETE /api/shiftschedulingsystem/{id}
- GET /api/shiftschedulingsystem/search
