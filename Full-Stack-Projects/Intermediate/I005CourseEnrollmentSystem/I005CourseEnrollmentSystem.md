...
## Synopsis
Course Enrollment System is an intermediate Java full-stack project in the Education domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Course Enrollment System.
...
- POST /api/auth/login
- GET /api/courseenrollmentsystem
- POST /api/courseenrollmentsystem
- GET /api/courseenrollmentsystem/{id}
- PUT /api/courseenrollmentsystem/{id}
- DELETE /api/courseenrollmentsystem/{id}
- GET /api/courseenrollmentsystem/search
