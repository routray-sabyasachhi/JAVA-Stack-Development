# Dockerized Web App Suite

## Synopsis
Dockerized Web App Suite is an intermediate Java full-stack project in the Developer Tools and Platform Engineering domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Dockerized Web App Suite.
...
- POST /api/auth/login
- GET /api/dockerizedwebappsuite
- POST /api/dockerizedwebappsuite
- GET /api/dockerizedwebappsuite/{id}
- PUT /api/dockerizedwebappsuite/{id}
- DELETE /api/dockerizedwebappsuite/{id}
- GET /api/dockerizedwebappsuite/search
