...
## Synopsis
CI Release Tracker is an intermediate Java full-stack project in the Developer Tools and Platform Engineering domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of CI Release Tracker.
...
- POST /api/auth/login
- GET /api/cireleasetracker
- POST /api/cireleasetracker
- GET /api/cireleasetracker/{id}
- PUT /api/cireleasetracker/{id}
- DELETE /api/cireleasetracker/{id}
- GET /api/cireleasetracker/search
