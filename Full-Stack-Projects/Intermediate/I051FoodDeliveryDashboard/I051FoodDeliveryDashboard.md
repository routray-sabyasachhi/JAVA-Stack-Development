...
## Synopsis
Food Delivery Dashboard is an intermediate Java full-stack project in the Logistics and Operations domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Food Delivery Dashboard.
...
- POST /api/auth/login
- GET /api/fooddeliverydashboard
- POST /api/fooddeliverydashboard
- GET /api/fooddeliverydashboard/{id}
- PUT /api/fooddeliverydashboard/{id}
- DELETE /api/fooddeliverydashboard/{id}
- GET /api/fooddeliverydashboard/search
