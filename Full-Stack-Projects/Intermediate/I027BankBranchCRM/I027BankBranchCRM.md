...
## Synopsis
Bank Branch CRM is an intermediate Java full-stack project in the Finance and Banking domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Bank Branch CRM.
...
- POST /api/auth/login
- GET /api/bankbranchcrm
- POST /api/bankbranchcrm
- GET /api/bankbranchcrm/{id}
- PUT /api/bankbranchcrm/{id}
- DELETE /api/bankbranchcrm/{id}
- GET /api/bankbranchcrm/search
