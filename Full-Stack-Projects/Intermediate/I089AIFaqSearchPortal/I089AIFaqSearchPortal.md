# AI Faq Search Portal

## Synopsis
AI Faq Search Portal is an intermediate Java full-stack project in the AI Applications domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of AI Faq Search Portal.
...
- POST /api/auth/login
- GET /api/aifaqsearchportal
- POST /api/aifaqsearchportal
- GET /api/aifaqsearchportal/{id}
- PUT /api/aifaqsearchportal/{id}
- DELETE /api/aifaqsearchportal/{id}
- GET /api/aifaqsearchportal/search
