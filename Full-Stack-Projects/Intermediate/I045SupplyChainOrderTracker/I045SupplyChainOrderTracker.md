...
## Synopsis
Supply Chain Order Tracker is an intermediate Java full-stack project in the Logistics and Operations domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Supply Chain Order Tracker.
...
- POST /api/auth/login
- GET /api/supplychainordertracker
- POST /api/supplychainordertracker
- GET /api/supplychainordertracker/{id}
- PUT /api/supplychainordertracker/{id}
- DELETE /api/supplychainordertracker/{id}
- GET /api/supplychainordertracker/search
