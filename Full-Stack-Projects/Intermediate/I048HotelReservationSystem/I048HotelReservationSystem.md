...
## Synopsis
Hotel Reservation System is an intermediate Java full-stack project in the Travel and Hospitality domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Hotel Reservation System.
...
- POST /api/auth/login
- GET /api/hotelreservationsystem
- POST /api/hotelreservationsystem
- GET /api/hotelreservationsystem/{id}
- PUT /api/hotelreservationsystem/{id}
- DELETE /api/hotelreservationsystem/{id}
- GET /api/hotelreservationsystem/search
