...
## Synopsis
Loan Processing System is an intermediate Java full-stack project in the Finance and Banking domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Loan Processing System.
...
- POST /api/auth/login
- GET /api/loanprocessingsystem
- POST /api/loanprocessingsystem
- GET /api/loanprocessingsystem/{id}
- PUT /api/loanprocessingsystem/{id}
- DELETE /api/loanprocessingsystem/{id}
- GET /api/loanprocessingsystem/search
