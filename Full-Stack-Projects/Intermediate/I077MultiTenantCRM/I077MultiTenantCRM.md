...
## Synopsis
Multi Tenant CRM is an intermediate Java full-stack project in the Productivity and Full-Stack Applications domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Multi Tenant CRM.
...
- POST /api/auth/login
- GET /api/multitenantcrm
- POST /api/multitenantcrm
- GET /api/multitenantcrm/{id}
- PUT /api/multitenantcrm/{id}
- DELETE /api/multitenantcrm/{id}
- GET /api/multitenantcrm/search
