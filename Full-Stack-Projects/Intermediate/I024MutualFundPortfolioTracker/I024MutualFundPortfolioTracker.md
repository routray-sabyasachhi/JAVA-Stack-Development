...
## Synopsis
Mutual Fund Portfolio Tracker is an intermediate Java full-stack project in the Finance and Banking domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Mutual Fund Portfolio Tracker.
...
- POST /api/auth/login
- GET /api/mutualfundportfoliotracker
- POST /api/mutualfundportfoliotracker
- GET /api/mutualfundportfoliotracker/{id}
- PUT /api/mutualfundportfoliotracker/{id}
- DELETE /api/mutualfundportfoliotracker/{id}
- GET /api/mutualfundportfoliotracker/search
