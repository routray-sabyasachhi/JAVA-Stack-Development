...
## Synopsis
Online Marketplace is an intermediate Java full-stack project in the E-commerce domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Online Marketplace.
...
- POST /api/auth/login
- GET /api/onlinemarketplace
- POST /api/onlinemarketplace
- GET /api/onlinemarketplace/{id}
- PUT /api/onlinemarketplace/{id}
- DELETE /api/onlinemarketplace/{id}
- GET /api/onlinemarketplace/search
