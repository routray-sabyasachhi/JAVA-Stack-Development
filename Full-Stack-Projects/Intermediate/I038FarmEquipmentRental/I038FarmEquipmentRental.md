...
## Synopsis
Farm Equipment Rental is an intermediate Java full-stack project in the Agriculture domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Farm Equipment Rental.
...
- POST /api/auth/login
- GET /api/farmequipmentrental
- POST /api/farmequipmentrental
- GET /api/farmequipmentrental/{id}
- PUT /api/farmequipmentrental/{id}
- DELETE /api/farmequipmentrental/{id}
- GET /api/farmequipmentrental/search
