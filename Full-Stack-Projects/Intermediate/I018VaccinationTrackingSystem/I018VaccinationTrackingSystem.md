...
## Synopsis
Vaccination Tracking System is an intermediate Java full-stack project in the Healthcare domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Vaccination Tracking System.
...
- POST /api/auth/login
- GET /api/vaccinationtrackingsystem
- POST /api/vaccinationtrackingsystem
- GET /api/vaccinationtrackingsystem/{id}
- PUT /api/vaccinationtrackingsystem/{id}
- DELETE /api/vaccinationtrackingsystem/{id}
- GET /api/vaccinationtrackingsystem/search
