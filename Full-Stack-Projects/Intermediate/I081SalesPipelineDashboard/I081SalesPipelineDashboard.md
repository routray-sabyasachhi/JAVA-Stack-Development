...
## Synopsis
Sales Pipeline Dashboard is an intermediate Java full-stack project in the Analytics domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Sales Pipeline Dashboard.
...
- POST /api/auth/login
- GET /api/salespipelinedashboard
- POST /api/salespipelinedashboard
- GET /api/salespipelinedashboard/{id}
- PUT /api/salespipelinedashboard/{id}
- DELETE /api/salespipelinedashboard/{id}
- GET /api/salespipelinedashboard/search
