...
## Synopsis
Online Assessment Platform is an intermediate Java full-stack project in the Productivity and Full-Stack Applications domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Online Assessment Platform.
...
- POST /api/auth/login
- GET /api/onlineassessmentplatform
- POST /api/onlineassessmentplatform
- GET /api/onlineassessmentplatform/{id}
- PUT /api/onlineassessmentplatform/{id}
- DELETE /api/onlineassessmentplatform/{id}
- GET /api/onlineassessmentplatform/search
