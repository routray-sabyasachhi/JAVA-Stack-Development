...
## Synopsis
College Event Management is an intermediate Java full-stack project in the Education domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of College Event Management.
...
- POST /api/auth/login
- GET /api/collegeeventmanagement
- POST /api/collegeeventmanagement
- GET /api/collegeeventmanagement/{id}
- PUT /api/collegeeventmanagement/{id}
- DELETE /api/collegeeventmanagement/{id}
- GET /api/collegeeventmanagement/search
