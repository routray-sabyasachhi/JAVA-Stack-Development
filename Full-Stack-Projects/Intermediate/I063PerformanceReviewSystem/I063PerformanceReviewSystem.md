...
## Synopsis
Performance Review System is an intermediate Java full-stack project in the HR and Enterprise domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Performance Review System.
...
- POST /api/auth/login
- GET /api/performancereviewsystem
- POST /api/performancereviewsystem
- GET /api/performancereviewsystem/{id}
- PUT /api/performancereviewsystem/{id}
- DELETE /api/performancereviewsystem/{id}
- GET /api/performancereviewsystem/search
