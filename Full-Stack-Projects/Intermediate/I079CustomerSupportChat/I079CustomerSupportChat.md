...
## Synopsis
Customer Support Chat is an intermediate Java full-stack project in the Social and Communication domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Customer Support Chat.
...
- POST /api/auth/login
- GET /api/customersupportchat
- POST /api/customersupportchat
- GET /api/customersupportchat/{id}
- PUT /api/customersupportchat/{id}
- DELETE /api/customersupportchat/{id}
- GET /api/customersupportchat/search
