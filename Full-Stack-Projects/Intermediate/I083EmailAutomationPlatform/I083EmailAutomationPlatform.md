...
## Synopsis
Email Automation Platform is an intermediate Java full-stack project in the AI Applications domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Email Automation Platform.
...
- POST /api/auth/login
- GET /api/emailautomationplatform
- POST /api/emailautomationplatform
- GET /api/emailautomationplatform/{id}
- PUT /api/emailautomationplatform/{id}
- DELETE /api/emailautomationplatform/{id}
- GET /api/emailautomationplatform/search
