...
## Synopsis
AI Customer Support Bot is an intermediate Java full-stack project in the AI Applications domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of AI Customer Support Bot.
...
- POST /api/auth/login
- GET /api/aicustomersupportbot
- POST /api/aicustomersupportbot
- GET /api/aicustomersupportbot/{id}
- PUT /api/aicustomersupportbot/{id}
- DELETE /api/aicustomersupportbot/{id}
- GET /api/aicustomersupportbot/search
