...
## Synopsis
Analytics Reporting Portal is an intermediate Java full-stack project in the Analytics domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Analytics Reporting Portal.
...
- POST /api/auth/login
- GET /api/analyticsreportingportal
- POST /api/analyticsreportingportal
- GET /api/analyticsreportingportal/{id}
- PUT /api/analyticsreportingportal/{id}
- DELETE /api/analyticsreportingportal/{id}
- GET /api/analyticsreportingportal/search
