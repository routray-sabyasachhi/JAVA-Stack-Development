...
## Synopsis
REST Api Management System is an intermediate Java full-stack project in the Developer Tools and Platform Engineering domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of REST Api Management System.
...
- POST /api/auth/login
- GET /api/restapimanagementsystem
- POST /api/restapimanagementsystem
- GET /api/restapimanagementsystem/{id}
- PUT /api/restapimanagementsystem/{id}
- DELETE /api/restapimanagementsystem/{id}
- GET /api/restapimanagementsystem/search
