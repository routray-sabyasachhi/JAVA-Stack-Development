...
## Synopsis
HR Recruitment Portal is an intermediate Java full-stack project in the HR and Enterprise domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of HR Recruitment Portal.
...
- POST /api/auth/login
- GET /api/hrrecruitmentportal
- POST /api/hrrecruitmentportal
- GET /api/hrrecruitmentportal/{id}
- PUT /api/hrrecruitmentportal/{id}
- DELETE /api/hrrecruitmentportal/{id}
- GET /api/hrrecruitmentportal/search
