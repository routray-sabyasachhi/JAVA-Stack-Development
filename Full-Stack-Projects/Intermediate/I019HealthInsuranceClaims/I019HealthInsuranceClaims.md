...
## Synopsis
Health Insurance Claims is an intermediate Java full-stack project in the Healthcare domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Health Insurance Claims.
...
- POST /api/auth/login
- GET /api/healthinsuranceclaims
- POST /api/healthinsuranceclaims
- GET /api/healthinsuranceclaims/{id}
- PUT /api/healthinsuranceclaims/{id}
- DELETE /api/healthinsuranceclaims/{id}
- GET /api/healthinsuranceclaims/search
