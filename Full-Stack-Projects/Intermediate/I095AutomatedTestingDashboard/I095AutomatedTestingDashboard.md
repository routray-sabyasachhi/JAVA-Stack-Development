...
## Synopsis
Automated Testing Dashboard is an intermediate Java full-stack project in the Analytics domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Automated Testing Dashboard.
...
- POST /api/auth/login
- GET /api/automatedtestingdashboard
- POST /api/automatedtestingdashboard
- GET /api/automatedtestingdashboard/{id}
- PUT /api/automatedtestingdashboard/{id}
- DELETE /api/automatedtestingdashboard/{id}
- GET /api/automatedtestingdashboard/search
