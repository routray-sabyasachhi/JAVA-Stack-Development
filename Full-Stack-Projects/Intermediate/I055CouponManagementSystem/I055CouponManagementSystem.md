...
## Synopsis
Coupon Management System is an intermediate Java full-stack project in the E-commerce domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Coupon Management System.
...
- POST /api/auth/login
- GET /api/couponmanagementsystem
- POST /api/couponmanagementsystem
- GET /api/couponmanagementsystem/{id}
- PUT /api/couponmanagementsystem/{id}
- DELETE /api/couponmanagementsystem/{id}
- GET /api/couponmanagementsystem/search
