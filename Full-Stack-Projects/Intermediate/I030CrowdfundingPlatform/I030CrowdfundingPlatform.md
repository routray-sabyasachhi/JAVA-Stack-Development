...
## Synopsis
Crowdfunding Platform is an intermediate Java full-stack project in the Finance and Banking domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Crowdfunding Platform.
...
- POST /api/auth/login
- GET /api/crowdfundingplatform
- POST /api/crowdfundingplatform
- GET /api/crowdfundingplatform/{id}
- PUT /api/crowdfundingplatform/{id}
- DELETE /api/crowdfundingplatform/{id}
- GET /api/crowdfundingplatform/search
