...
## Synopsis
AI Recipe Recommender is an intermediate Java full-stack project in the AI Applications domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of AI Recipe Recommender.
...
- POST /api/auth/login
- GET /api/aireciperecommender
- POST /api/aireciperecommender
- GET /api/aireciperecommender/{id}
- PUT /api/aireciperecommender/{id}
- DELETE /api/aireciperecommender/{id}
- GET /api/aireciperecommender/search
