...
## Synopsis
Marketing Campaign Manager is an intermediate Java full-stack project in the AI Applications domain. A production-style Java full-stack system with authentication, role-based workflows, REST APIs, relational data modeling, reporting screens, and deployment readiness.
...
Adjust these entities based on the exact domain of Marketing Campaign Manager.
...
- POST /api/auth/login
- GET /api/marketingcampaignmanager
- POST /api/marketingcampaignmanager
- GET /api/marketingcampaignmanager/{id}
- PUT /api/marketingcampaignmanager/{id}
- DELETE /api/marketingcampaignmanager/{id}
- GET /api/marketingcampaignmanager/search
